...
- **Voice resolution** (`resolve_voice`, `find_voice_by_name`) — searches ElevenLabs voices by name (partial, case-insensitive) or accepts an exact voice ID; defaults to "Rachel"
